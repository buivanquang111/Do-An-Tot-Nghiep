...
import com.example.thuctaptotnghiep.Fragment.ChoLayHangFragment;
import com.example.thuctaptotnghiep.Fragment.ChoXacNhanFragment;
import com.example.thuctaptotnghiep.Fragment.DaGiaoFragment;
import com.example.thuctaptotnghiep.Fragment.DangGiaoFragment;
...
//        bundle.putString("pass",LoginActivity.user.getPassword());
    ...
    public void goToChoXacNhanFragment(User user){
        FragmentTransaction transaction=getSupportFragmentManager().beginTransaction();
        ChoXacNhanFragment choXacNhanFragment = new ChoXacNhanFragment();
        Bundle bundle=new Bundle();
        bundle.putSerializable("object_user_choxacnhan",user);
        choXacNhanFragment.setArguments(bundle);

        transaction.replace(R.id.frame_layout,choXacNhanFragment);
        transaction.addToBackStack(ChoXacNhanFragment.TAG);
        transaction.commit();
    }
    public void goToDangGiaoFragment(User user){
        FragmentTransaction transaction=getSupportFragmentManager().beginTransaction();
        DangGiaoFragment dangGiaoFragment = new DangGiaoFragment();
        Bundle bundle=new Bundle();
        bundle.putSerializable("object_user_danggiao",user);
        dangGiaoFragment.setArguments(bundle);

        transaction.replace(R.id.frame_layout,dangGiaoFragment);
        transaction.addToBackStack(DangGiaoFragment.TAG);
        transaction.commit();
    }
    public void goToCHoLayHangFragment(User user){
        FragmentTransaction transaction=getSupportFragmentManager().beginTransaction();
        ChoLayHangFragment choLayHangFragment = new ChoLayHangFragment();
        Bundle bundle=new Bundle();
        bundle.putSerializable("object_user_cholayhang",user);
        choLayHangFragment.setArguments(bundle);

        transaction.replace(R.id.frame_layout,choLayHangFragment);
        transaction.addToBackStack(ChoXacNhanFragment.TAG);
        transaction.commit();
    }
    public void goToDaGiaoFragment(User user){
        FragmentTransaction transaction=getSupportFragmentManager().beginTransaction();
        DaGiaoFragment daGiaoFragment = new DaGiaoFragment();
        Bundle bundle=new Bundle();
        bundle.putSerializable("object_user_dagiao",user);
        daGiaoFragment.setArguments(bundle);

        transaction.replace(R.id.frame_layout,daGiaoFragment);
        transaction.addToBackStack(DaGiaoFragment.TAG);
        transaction.commit();
    }
