...
import com.example.thuctaptotnghiep.Adapter.DangGiaoAdapter;
...
public class DangGiaoFragment extends Fragment {
    ...
    public static final String TAG=DangGiaoFragment.class.getName();

    User user;
    HoaDon hoaDon;
    List<HoaDon> hoaDonList;
    DangGiaoAdapter mAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rvSP = view.findViewById(R.id.rvSPDangGiao);
        imgback = view.findViewById(R.id.image_back_danggiao);
        ...
        if (bundle!=null){
            user= (User) bundle.get("object_user_danggiao");
        }
        ...
        getHoaDonDangGiao(String.valueOf(user.getId()));
        mAdapter = new DangGiaoAdapter(hoaDonList,getContext());
