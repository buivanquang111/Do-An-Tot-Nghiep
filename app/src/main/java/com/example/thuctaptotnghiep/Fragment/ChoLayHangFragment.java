...
import com.example.thuctaptotnghiep.Adapter.ChoLayHangAdapter;
...
public class ChoLayHangFragment extends Fragment {
    public static final String TAG=ChoLayHangFragment.class.getName();
    User user;
    HoaDon hoaDon;
    List<HoaDon> hoaDonList;
    ChoLayHangAdapter mAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_cholayhang,container,false);

        mainActivity = (MainActivity) getActivity();
        rvSP = view.findViewById(R.id.rvSPChoLayHang);
        imgback = view.findViewById(R.id.image_back_cholayhang);

        hoaDonList = new ArrayList<>();

        Bundle bundle=getArguments();
        if (bundle!=null){
            user= (User) bundle.get("object_user_cholayhang");
        }
        ...
        getHoaDonChoLayHang(String.valueOf(user.getId()));
        mAdapter = new ChoLayHangAdapter(hoaDonList,getContext());
