...
public class ProductNamAdapter extends RecyclerView.Adapter<ProductNamAdapter.ProductNamViewHolder>{
    private List<Product> dsproduct;
    private Context mcontext;
    IClickItemListener mIClickItemListener;

    public ProductNamAdapter(List<Product> dsproduct, Context mcontext, IClickItemListener mIClickItemListener) {
    ...
    @NonNull
    @Override
    public ProductNamAdapter.ProductNamViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_product,parent,false);
        return new ProductNamViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ProductNamAdapter.ProductNamViewHolder holder, int position) {
    ...
    public class ProductNamViewHolder extends RecyclerView.ViewHolder {
        private ImageView img;
        private TextView txttitle,txtgia;
        private LinearLayout linearLayout;
        public ProductNamViewHolder(@NonNull View itemView) {
            super(itemView);
