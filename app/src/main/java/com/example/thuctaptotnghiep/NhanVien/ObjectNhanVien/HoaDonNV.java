...
public class HoaDonNV {
    ...
    public HoaDonNV(int id, String img, String tenSp, int slMua, String hoTen, String sdt, String diaChiNhan, double tongTien, String ngayDat, int xacNhan, int nvGiaoHang, int daNhan) {
        this.id = id;
        this.img = img;
        this.tenSp = tenSp;
        this.slMua = slMua;
